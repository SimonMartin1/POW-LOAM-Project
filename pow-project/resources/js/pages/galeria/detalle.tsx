    ...
    return (
        ...
        >
            ...
            <div className="min-h-screen bg-[#F7F3EB] px-6 py-10 flex justify-center">
                <div className="max-w-3xl w-full bg-white rounded-3xl shadow-xl p-10 space-y-10">
                    ...
                    <div className="space-y-2">
                        <h1 className="text-3xl md:text-4xl font-black uppercase tracking-tight text-[#2A332D] font-['Montserrat']">
                            {imagen.nombre}
                        </h1>

                        {imagen.autor && (
                            <p className="text-lg text-[#6A7A70]">
                                <span className="font-semibold text-[#2A332D]">
                                    Autor:
                                </span>{" "}
                                {imagen.autor}
                            </p>
                    ...
                    {/* DESCRIPCIÓN */}
                    {imagen.descripcion && (
                        <p className="text-[#444] leading-relaxed text-md whitespace-pre-line">
                            {imagen.descripcion}
                        </p>
                    )}
